...
This directory contains configuration files for the Clawdbot Trader Bench. These JSON configuration files define the parameters and settings used by the trading agents during execution.
