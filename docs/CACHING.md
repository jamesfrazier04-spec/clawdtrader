...
The Clawdbot Trader frontend includes a **two-tier caching system** designed to dramatically improve page load times by pre-computing and caching expensive calculations. The system supports multiple markets including **US stocks**, **A-shares (daily)**, and **A-shares (hourly)** with seamless 1D/1H toggle functionality.
