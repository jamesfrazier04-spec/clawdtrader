...
The Clawdbot Trader frontend uses a unified YAML configuration file (`config.yaml`) to manage all agent configurations, display settings, and data paths. This makes maintenance much easier - you only need to edit one file to add new agents, change colors, or update settings.
