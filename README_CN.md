<div align="center">
  <picture>
      <img src="./assets/Clawdbot Trader-log.png" width="30%" style="border: none; box-shadow: none;">
  </picture>
</div >

<div align="center">

# 🚀 Clawdbot Trader: Can AI Beat the Market?
### *让AI在金融市场中一展身手*
...
> **Clawdbot Trader让三个不同的AI模型（OpenAI、Claude、DeepSeek），每个都采用独特的投资策略，在同一个市场中完全自主决策、竞争，看谁能在纳斯达克100、上证50或加密货币交易中赚得最多！**

### 🎯 核心特性

- 🤖 **完全自主决策**: AI代理100%独立分析、决策、执行，零人工干预
- 🛠️ **纯工具驱动架构**: 基于MCP工具链，AI通过标准化工具调用完成所有交易操作
- 🏆 **多模型竞技场**: 部署多个AI模型（GPT、Claude、DeepSeek）进行竞争性交易
...
Clawdbot Trader Bench的核心创新是其**完全可重放**的交易环境，确保AI代理在历史市场数据上的性能评估具有科学严谨性和可重复性。
...
```bash
# 1. 克隆项目
git clone https://github.com/HKUDS/Clawdbot Trader.git
cd Clawdbot Trader
...
Clawdbot Trader Bench采用模块化设计，支持轻松集成第三方策略和自定义AI代理。
...
- **💬 讨论**: [GitHub Discussions](https://github.com/HKUDS/Clawdbot Trader/discussions)
- **🐛 问题**: [GitHub Issues](https://github.com/HKUDS/Clawdbot Trader/issues)
...
<div align="center">
  <a href="https://github.com/HKUDS/Clawdbot Trader/graphs/contributors">
    <img src="https://contrib.rocks/image?repo=HKUDS/Clawdbot Trader" style="border-radius: 15px; box-shadow: 0 0 20px rgba(0, 217, 255, 0.3);" />
  </a>
</div>

## 免责声明

Clawdbot Trader项目所提供的资料仅供研究之用，并不构成任何投资建议。投资者在作出任何投资决策之前，应寻求独立专业意见。任何过往表现未必可作为未来业绩的指标。阁下应注意，投资价值可能上升亦可能下跌，且并无任何保证。Clawdbot Trader项目的所有内容仅作研究之用，并不构成对所提及之证券／行业的任何投资推荐。投资涉及风险。如有需要，请寻求专业咨询。
...
[![GitHub stars](https://img.shields.io/github/stars/HKUDS/Clawdbot Trader?style=social)](https://github.com/HKUDS/Clawdbot Trader)
[![GitHub forks](https://img.shields.io/github/forks/HKUDS/Clawdbot Trader?style=social)](https://github.com/HKUDS/Clawdbot Trader)
...
<div align="center">
  <a href="https://star-history.com/#HKUDS/Clawdbot Trader&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=HKUDS/Clawdbot Trader&type=Date&theme=dark" />
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=HKUDS/Clawdbot Trader&type=Date" />
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=HKUDS/Clawdbot Trader&type=Date" style="border-radius: 15px; box-shadow: 0 0 30px rgba(0, 217, 255, 0.3);" />
    </picture>
  </a>
</div>
...
<p align="center">
  <em> ❤️ 感谢访问 ✨ Clawdbot Trader!</em><br><br>
  <img src="https://visitor-badge.laobi.icu/badge?page_id=HKUDS.Clawdbot Trader&style=for-the-badge&color=00d4ff" alt="Views">
</p>
